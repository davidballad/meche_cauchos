-- Si ya tenías el proyecto con solo la tabla `parts`, ejecuta este script en el SQL Editor.
-- Crea `transactions`, la función `create_transaction_sale` y políticas RLS.
