# MZ Cauchos & Accesorios — Catálogo de repuestos

Sitio de una sola página (HTML, CSS y JavaScript sin frameworks ni herramientas de build) para gestionar el inventario de **MZ Cauchos & Accesorios**. El backend es [Supabase](https://supabase.com/) (plan gratuito).
...
git init
git add .
git commit -m "Catálogo MZ Cauchos & Accesorios con Supabase"
git branch -M main
...
Uso interno para MZ Cauchos & Accesorios; adapta la licencia según tu negocio.
